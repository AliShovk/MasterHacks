...
<meta name="description" content="Видео в категории «<?= h($tag) ?>» на MasterHacks.">
...
.breadcrumb{display:flex;align-items:center;gap:8px;flex-wrap:wrap;font-size:13px;margin-bottom:16px;color:rgba(255,255,255,.5)}
...
<input type="text" name="q" class="search-input" value="" placeholder="Поиск видео...">
<button type="submit" class="search-btn" title="Найти"><i class="fas fa-search"></i></button>
</form>
</header>
<div class="container">
<div class="breadcrumb"><a href="/">Главная</a> <span class="sep">></span> <span class="current">Категория: <?= h($tag) ?></span></div>
<?php if ($error): ?>
<div class="error-msg"><?= h($error) ?></div>
<?php elseif ($searched): ?>
<?php if (count($results) > 0): ?>
<div class="results-info">Найдено: <?= count($results) ?> видео в категории «<?= h($tag) ?>»</div>
...
<?php endforeach; ?>
<?php else: ?>
<div class="no-results"><i class="fas fa-folder-open"></i><p>Ничего не найдено</p><p style="font-size:13px;margin-top:8px">В категории «<?= h($tag) ?>» пока нет видео</p></div>
<?php endif; ?>
<?php else: ?>
<div class="no-results"><i class="fas fa-tags"></i><p>Категория не указана</p></div>
<?php endif; ?>
</div>
</body>
</html>
